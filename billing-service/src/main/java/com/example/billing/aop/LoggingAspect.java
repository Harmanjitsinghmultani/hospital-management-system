...
public class LoggingAspect {
    ...
    @Before("execution(* com.example.billing.controller..*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.example.billing.controller..*(..))", returning = "result")
    ...
    @Around("execution(* com.example.billing.service.impl..*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.example.billing..*(..))", throwing = "ex")
